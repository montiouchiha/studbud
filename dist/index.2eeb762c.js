...
function loadTrack(track_index1) {
    ...
    track_art.style.backgroundImage = "url(" + track_list[track_index1].image + ")";
    track_name.textContent = track_list[track_index1].name;
    track_artist.textContent = track_list[track_index1].artist;
    now_playing.textContent = "PLAYING " + (track_index1 + 1) + " OF " + track_list.length;
...
//# sourceMappingURL=index.2eeb762c.js.map
